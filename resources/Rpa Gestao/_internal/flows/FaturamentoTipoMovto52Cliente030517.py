...
class RpaProcess(Promax):
    ...
    async def filters():
        ...
        campo_tipo_movto = MediaLoader.Image("2fe04e524ba40505a82e03a2819429cc").path()
        movto_found = await isImageOnScreen(campo_tipo_movto,timeout=5)
        if movto_found:
            await clickOnTarget(campo_tipo_movto)
